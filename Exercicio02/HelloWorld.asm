...
main:
	loadn r0, #532
	loadn r1, #bordabonita
	loadn r2, #2304
	
	call Imprimestr
	
	loadn r0, #572; Posicao na tela onde a mensagem sera' escrit
	loadn r1, #mensagem2	; Carrega r1 com o endereco do vetor que contem a mensagem1
